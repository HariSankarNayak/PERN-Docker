...
export const ListEmployee = () => {
  const { employee, editEmployee, deleteEmployee , employees, setEmployees} = useContext(GlobalContext);
              ...
              <div className="row">
                {employees.length > 0 ? (
                          ...
                          <div className="row">
                            ...
                            <div className="col-md-4 actionIcons text-right">
                              ...
                              <div className="roundIcon">
                                <button className="noBg" onClick={() => deleteEmployee(employee.id)} >
                                <svg
                                  width="24"
                                  height="24"
                                  viewBox="0 0 24 24"
                  ...
                  <div className="noList">
                    <p>No You can hire me to see my name here...  😇 </p>
                    <Link to="/create">
